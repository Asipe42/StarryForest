...
//            _src.isValid = Validate(); // Moved down
            ...
            GUILayout.BeginHorizontal();
                ...
                EditorGUI.BeginChangeCheck();
                    ...
                    _src.targetGO = (UnityEngine.GameObject)EditorGUILayout.ObjectField(_src.targetGO, typeof(UnityEngine.GameObject), true);
                        }
            ...
            UnityEngine.GameObject targetGO = _src.targetIsSelf ? _src.gameObject : _src.targetGO;
...
//                _src.animationType = (DOTweenAnimation.AnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
        ...
        bool Validate(UnityEngine.GameObject targetGO)
        {
        ...
        void GUIEndValueV3(UnityEngine.GameObject targetGO, bool optionalTransform = false)
        {
            GUILayout.BeginHorizontal();
            GUIToFromButton();
